...
public class CameraActivity  extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback {
    ...
    void InitView()
    {
        ...
        m_svDisplay = (SurfaceView)findViewById(R.id.sv_display);
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        if(permissions[0].compareTo(Manifest.permission.CAMERA) == 0)
        {
            ...
            PermissionCheck.Check(this, Manifest.permission.RECORD_AUDIO);
        }
...
//        m_CameraVideoStream
        int percheck = PermissionCheck.Check(this, Manifest.permission.CAMERA);
...
//        }
    ...
    int  StartStream(boolean islive)
    {
        ...
        if( PermissionCheck.Check(this, Manifest.permission.READ_EXTERNAL_STORAGE) == PermissionCheck.AUTHPERMISSION && PermissionCheck.Check(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PermissionCheck.AUTHPERMISSION)
        {
